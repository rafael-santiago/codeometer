...
func TestGetCourier12pxParams(t *testing.T) {
    ...
    if charPerLineNr != charPerLineA4Courier12px {
        t.Errorf(`charPerLineNr != charPerLineA4Courier12px`, charPerLineNr, charPerLineA4Courier12px)
    }
    if charPerPageNr != charPerPageA4Courier12px {
        t.Errorf(`charPerPageNr != charPerPageA4Courier12px`, charPerPageNr, charPerPageA4Courier12px)
    }
}
...
func TestGetCourier10pxParams(t *testing.T) {
    ...
    if charPerLineNr != charPerLineA4Courier10px {
        t.Errorf(`charPerLineNr != charPerLineA4Courier10px`, charPerLineNr, charPerLineA4Courier10px)
    }
    if charPerPageNr != charPerPageA4Courier10px {
        t.Errorf(`charPerPageNr != charPerPageA4Courier10px`, charPerPageNr, charPerPageA4Courier10px)
    }
}

func TestGetA4PaperWidthSizeInMM(t *testing.T) {
    if size := GetA4PaperWidthSizeInMM(); size != a4PaperWidthInMM {
        t.Errorf(`GetA4PaperSizeInMM() != A4PaperWidthInMM`, size, a4PaperWidthInMM)
    }
}
